...
// // depthFirstForEach()
console.log('\ndepthFirstForEach()');
console.log('1. binTest BEFORE Callback() invoked:\n', binTest);
const foo = x => x * 2;
console.log(`2. the callback function: ${foo}`);
console.log('3. The method binTest.depthFirstForEach(foo) results in:', binTest.depthFirstForEach(foo));
console.log('4. binTest AFTER Callback() invoked:\n', binTest);
