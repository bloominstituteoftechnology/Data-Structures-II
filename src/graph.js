...
class Graph {
  ...
  addVertex(value, edges = []) {
    ...
    // ensuring that the edges that this node is connected to also
    ...
    // we need to check if there are exactly two nodes in the graph and they
    // dont have any connection between them
  ...
  removeVertex(value) {
    ...
    //   this.vertices.splice(this.vertices.indexOf(value), 1);
    // }
    // if (value.numberOfEdges > 0) {
    //   this.vertices.forEach((elem, i) => {
    //     if (elem.edges.includes(value)) {
    //       elem.edges = elem.edges.splice(elem.edges.indexOf(value), 1);
    //     }
    //   });
    // }
  }
  ...
  removeEdge(fromVertex, toVertex) {
    ...
    //   if (toVertex.numberOfEdges === 0) this.removeVertex(fromVertex.value);
    // }
    if (this.checkIfEdgeExists(fromVertex, toVertex)) {
