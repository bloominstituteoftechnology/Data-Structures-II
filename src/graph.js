...
class Graph {
  ...
  addVertex(value, edges = []) {
    ...
    // ensure that the edges taht this node is connected to also
    ...
    // we need to check if there are two nodes in the graph and they
  ...
  checkIfEdgeExists(fromVertex, toVertex) {
    // return fromVertex.edges.includes(fromVertex) && toVertex.edges.includes(fromVertex);
