...
class Heap {
    ...
    delete() {
      ...
      //console.log(this.getStorage()[this.getSize() - 1])
      this.swap(0, this.getSize());
      // console.log(this.getStoragethis.getSize)
    ...
    bubbleUp(index) {
      ...
      if (parent > checkValue) return;
      if (parent < checkValue) this.swap(index, parIndex);
