...
describe('Heap', () => {
  ...
  // Added a test to check deleteMin method
  it('should delete elements from least to greatest', () => {
    heap.insert(6);
    heap.insert(7);
    heap.insert(5);
    heap.insert(8);
    ...
    while (heap.getSize() > 0) {
      ascendingOrder.push(heap.deleteMin());
    }

    expect(ascendingOrder).toEqual([1, 2, 5, 5, 6, 7, 8, 10]);
  });
});
